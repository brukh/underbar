(function() {
  ...
  _.every = function(collection, iterator) {
    ...
    return _.reduce(collection, function(truthTest, value){
      if (truthTest) {
        return !!iterator(value); //!! - turns any falsey value false (example: undefined, null)
      } 
      else {
        return false;
      }
  ...
  _.shuffle = function(array) {
        ...
        for (var i = 0; i < array.length; i++) {
           var num = Math.floor(Math.random() * ((copyArr.length - 1) + 1));
           shuffledArr.push(copyArr[num]);
